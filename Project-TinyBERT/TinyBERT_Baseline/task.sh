...
#SBATCH --mem                   40G
#SBATCH --gres                  gpu:1
#SBATCH --output                Base_task.out
#SBATCH --error                 Base_task.err
...
python task_distill.py --do_eval --student_model /data/home/mc25653/Pretrained-Language-Model/TinyBERT/Base_output --task_name CoLA --output_dir /data/home/mc25653/Pretrained-Language-Model/TinyBERT/eval_output --do_lower_case --eval_batch_size 32 --max_seq_length 64 --data_dir CoLA
